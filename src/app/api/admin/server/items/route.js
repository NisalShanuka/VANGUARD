...
export async function GET() {
    ...
    try {
        const res = await fetch(`${FIVEM_API_URL}/api/items`, {
            method: 'GET',
        ...
        console.error('[FiveM API GET Items Error]', error.message);
        return NextResponse.json({ error: 'Failed to fetch items from game server' }, { status: 500 });
    }
}
